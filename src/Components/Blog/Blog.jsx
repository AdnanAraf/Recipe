          ...
          <div className="border-2 lg:h-[600px] h-[1000px] lg:w-[600px] p-[10px] m-auto my-[30px]">
            ...
            <p className="font-title font-semibold text-[20px]">
              ...
              <span className="font-title">
                ...
                server-side. It is an open-source, cross-platform environment
                that enables building scalable, high-performance network
                applications using a non-blocking I/O model. Node.js provides
                core modules for handling file system I/O, networking, and other
                low-level operations, making it a popular choice for building
                server-side applications such as real-time chat applications,
                e-commerce websites, and APIs
              </span>
              <br></br>
              <br></br>
              <span>
                ...
                process of building server-side applications by providing a set
                of pre-built functionalities that can be easily extended using
                middleware. Express.js enables developers to build single-page
                applications, APIs, and dynamic websites by providing a simple
                and intuitive API. It is widely used in the industry due to its
